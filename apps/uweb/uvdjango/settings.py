...
DIAG_HIRES_CAM_PATH = os.environ['HOME'] + '/acme_hires_cam_climo'
DIAG_LORES_CAM_PATH = os.environ['HOME'] + '/acme_lores_cam_climo'
DIAG_CAM_OUTPUT_PATH = os.environ['HOME'] + '/cam_output'
DIAG_HIRES_CLM_PATH = os.environ['HOME'] + '/acme_hires_clm_climo'
DIAG_LORES_CLM_PATH = os.environ['HOME'] + '/acme_lores_clm_climo'
DIAG_CLM_OUTPUT_PATH = os.environ['HOME'] + '/acme_clm_climo'
